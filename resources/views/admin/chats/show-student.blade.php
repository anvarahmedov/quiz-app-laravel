...
@section('content')
    ...
    <div class="card m-3">
        ...
        {{--        <div class="card-body m-3 " style="border: 3px solid #5f61e6; border-radius: 10px;">--}}
...
{{--                @dd($teacher_name)--}}
                @if($message->type == 1)
                    <div class="card w-75 float-start m-2" style="box-shadow: 0px 0px 4px 4px #dbdcde; border-radius: 0px 25px 25px 50px; border: 2px solid darkblue  ">
                        <div class="p-3">
                            <p style="color: darkblue;" ><i class="bx bx-user-circle" style="font-size: 30px;"></i> {{ $teacher_name->full_name }}</p>
