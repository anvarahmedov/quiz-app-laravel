...
@section('content')
    <div class="card m-2 p-2" style="box-shadow: 0px 0px 5px 5px rgba(194,215,236,0.63)">
        <div class="card-header d-flex justify-content-between">
            <h1 class="text text-center text-dark">O'qituvchilar ro'yhati</h1>
                    ...
                    <div class="modal fade" id="editModal{{$teacher->id}}" tabindex="-1"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form action="{{route('teachers.update',$teacher->id)}}" method="post">@csrf
                                    @method('PUT')
                    ...
                    <div class="modal fade" id="deleteModal{{$teacher->id}}" tabindex="-1"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form action="{{route('teachers.destroy',$teacher->id)}}" method="post">@csrf
                                    @method('DELETE')
    ...
    <div class="modal fade" id="createModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{route('teachers.store')}}" method="post">@csrf
                    <div class="modal-body">
